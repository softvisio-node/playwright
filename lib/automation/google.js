...
export default class Google {
    ...
    async _browseTargetSite ( page, { pagesToVisitMin = 10, pagesToVisitMax = 20, pageVisitTimeoutMin = 10000, pageVisitTimeoutMax = 20000 } = {} ) {
    ...
    async #createPage ( { location, randomCoordinates = false, minDistance, maxDistance, proxy, device } ) {
        ...
        if ( typeof location === "string" ) {
            ...
            if ( randomCoordinates ) {
                ...
                if ( !geolocation.data?.coordinates ) throw result( [500, `Unable to get coordinates for location`] );
