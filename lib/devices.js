import { getRandomArrayValue } from "#core/utils";
...
class BrowserDevices {
    windows10 () {
        const screen = getRandomArrayValue( DESKTOP_RESOLUTIONS );
    ...
    // randm device
    random () {
        const deviceName = getRandomArrayValue( ALL_DEVICES );
    ...
    desktop () {
        const deviceName = getRandomArrayValue( DESKTOP_DEVICES );
    ...
    mobile () {
        const deviceName = getRandomArrayValue( MOBILE_DEVICES );
    ...
    windows () {
        const deviceName = getRandomArrayValue( WINDOWS_DEVICES );
