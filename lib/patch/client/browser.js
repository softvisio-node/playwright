...
browser.Browser = class extends browser.Browser {
    ...
    async newContext ( { stealth = true, ...options } = {} ) {
        ...
        if ( stealth || ctx.browser().isHeadless || options.userAgent ) {
            ...
            stealth.isMobile = Boolean( options.isMobile );
    ...
    async #patchUserAgent ( page, options ) {
        ...
        const override = {
            ...
            "platform": userAgent.os.family, // XXX short
            ...
            "userAgentMetadata": {
                ...
                "platform": userAgent.os.family, // XXX long
                "platformVersion": userAgent.os.version,
                "architecture": "x86", // XXX
                "model": userAgent.device.model || "",
                "mobile": Boolean( options.isMobile ?? isMobile ),
            },
        };
