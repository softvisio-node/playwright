...
browser.Browser = class extends browser.Browser {
    ...
    async #patchUserAgent ( page, options ) {
        ...
        const override = {
            ...
            "userAgentMetadata": {
                "brands": this.#createUserAgentBrands( stealth.userAgent.browser.family, stealth.userAgent.browser.version, false ),
                "fullVersionList": this.#createUserAgentBrands( stealth.userAgent.browser.family, stealth.userAgent.browser.version, true ),
