...
browser.Browser = class extends browser.Browser {
    ...
    async #patchUserAgent ( page, options ) {
        ...
        const override = {
            ...
            "platform": PLATFORMS[ stealth.userAgent.os.family?.toLowerCase() ]?.short || "",
            "acceptLanguage": undefined,
            "userAgentMetadata": {
                "brands": this.#createUserAgentBrands( stealth.userAgent.browser.family, stealth.userAgentVersion || stealth.userAgent.browser.version ),
                "fullVersion": stealth.userAgentVersion || stealth.userAgent.browser.version,
                "platform": PLATFORMS[ stealth.userAgent.os.family?.toLowerCase() ]?.long || "Unknown",
    ...
    #createUserAgentBrands ( family, userAgentVersion ) {
